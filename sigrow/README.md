...
-----|-------------|------------
0x0E | 0x0091      | Between BOD (0x80-0x8F) and VREF (0xA0-0xAF).
0x0F | 0x0092      | Between BOD (0x80-0x8F) and VREF (0xA0-0xAF).
0x10 | ??????      |
0x14 | 0x0079      | CLKCTRL, OSCCAL32K
0x15 | 0x0075      | CLKCTRL. Maybe temp calibrpration for 32k osc?
0x16 | ??????      |
0x17 | ??????      |
0x1C | ??????      |
0x1D | ??????      |
